...
export default function PracticePage() {
  ...
  const mode = (rawMode === 'subject' || rawMode === 'chapter' ? rawMode : 'chapter') as 'chapter' | 'subject'
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card className="p-5">
          ...
          <div className="space-y-2 text-xs text-text2">
            ...
            {chapter && <p className="flex justify-between"><span>Chapter</span><span className="font-display font-semibold text-text">{chapter.name}</span></p>}
